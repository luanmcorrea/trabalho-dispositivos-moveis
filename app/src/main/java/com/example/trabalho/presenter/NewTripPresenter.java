...
public class NewTripPresenter implements ActivityContract.ActivityFormPresenter {
    ...
    public void submit(ModelContract.Model tripModel) {
        ...
        try {
            this.validate(); //valida as informções passadas pelo user
            ...
            db.collection("trips")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Intent intent = new Intent(tripView.getContext(), TripDetailsActivity.class); // vai pra próxima tela
                            intent.putExtra("objTrip", trip); // coloca o objeto na intent
                            tripView.navigate(intent); //vai salvar a pesquisa no firebase
                        }
                    })
